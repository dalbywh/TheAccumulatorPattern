...
def run_test_factorial():
    ...
    answer_from_math = 120
    answer_from_my_code = factorial(5)
    print('Test 5 expected (from known):', answer_from_math)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    expected = 4
    answer = count_cosines_from(5, 8, -0.25)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.21903  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(25, 30)
